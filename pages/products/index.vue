            ...
            <tr v-for="item in filteredList" :key="item._id" class="month-item">
              ...
              <td>
                <div class="d-flex ga-2 align-center justify-center">
                  <RouterLink :to="`/products/edit/${item._id}`">
                  ...
                  <RouterLink to="" @click.prevent="handleCopyProduct(item)">
                    <v-avatar color="lightinfo" size="32">
                      <Icon icon="solar:copy-linear" class="text-info" height="18" />
                    </v-avatar>
                    <v-tooltip activator="parent" location="bottom">کپی</v-tooltip>
                  </RouterLink>
                  ...
                  <RouterLink to="" @click.prevent="handleDeleteProduct(item._id)">
