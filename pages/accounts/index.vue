                ...
                <template v-slot:default>
                    ...
                    <tbody>
                        <tr v-for="item in filteredList" :key="item._id" class="month-item">
                            ...
                            <td>
                                <div v-if="item.type !== 'system'" class="d-flex ga-2 align-center justify-center">
                                    <RouterLink :to="`/accounts/edit/${item._id}`">
                                    ...
                                    <RouterLink to="" @click.prevent="handleSetDefault(item)">
                                ...
                                <div v-else class="text-center">
                                    <span class="text-grey">سیستمی</span>
                                </div>
                            </td>
                        </tr>
                    </tbody>
